...
var _plats = __webpack_require__(26);
...
restRouter.use("/plat", _plats.platRouter);
restRouter.use("/profil", _profil.profilRouter);
...
var _gravatar = __webpack_require__(25);
...
exports.default = {
    signup: function signup(req, res) {
        ...
        return _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
            var _userService$validate, errors, isValid, encryptedPass, avatar, user, userRegister;
            ...
            return _regenerator2.default.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            _context.prev = 0;
                            _userService$validate = _user2.default.validateSignup(req.body), errors = _userService$validate.errors, isValid = _userService$validate.isValid;
                        ...
                        case 4:
                            encryptedPass = _user2.default.encryptPassword(req.body.password);
                            ...
                            _context.next = 8;
                            return _user4.default.findOne({ email: req.body.email });
            ...
            return _regenerator2.default.wrap(function _callee2$(_context2) {
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        case 0:
                            _context2.prev = 0;
                            _userService$validate2 = _user2.default.validateLogin(req.body), errors = _userService$validate2.errors, isValid = _userService$validate2.isValid;
                        ...
                        case 9:
                            authenticated = _user2.default.comparePassword(req.body.password, user.password);
...
var _bcryptjs = __webpack_require__(22);
...
exports.default = {
    ...
    validateSignup: function validateSignup(body) {
        ...
        if (!_validator2.default.isLength(body.password, { min: 6, max: 30 })) {
...
var _plat = __webpack_require__(27);

Object.defineProperty(exports, 'platRouter', {
  enumerable: true,
  get: function get() {
    return _plat.platRouter;
  }
});
...
exports.platRouter = undefined;

var _express = __webpack_require__(0);

var _express2 = _interopRequireDefault(_express);

var _plat = __webpack_require__(28);

var _plat2 = _interopRequireDefault(_plat);
...
var platRouter = exports.platRouter = _express2.default.Router();
...
var _plat = __webpack_require__(29);

var _plat2 = _interopRequireDefault(_plat);

var _plat3 = __webpack_require__(30);

var _plat4 = _interopRequireDefault(_plat3);
...
exports.default = {
  create: function create(req, res) {
    ...
    return _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
      var _PlatServices$validat, errors, isValid, plat;
      ...
      return _regenerator2.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _PlatServices$validat = _plat4.default.validateBody(req.body), errors = _PlatServices$validat.errors, isValid = _PlatServices$validat.isValid;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 3:
              ...
              return _context2.abrupt("return", res.status(404).json({ err: 'could not find the plat' }));

            case 6:
              return _context2.abrupt("return", res.json(plat));
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              id = req.params.id;
              _context3.next = 4;
              return _plat2.default.findById(id);
            ...
            case 4:
              ...
              return _context3.abrupt("return", res.status(404).json({ err: 'could not find this plat' }));

            case 7:
              return _context3.abrupt("return", res.json(plat));
  ...
  update: function update(req, res) {
    ...
    return _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee4() {
      var id, _PlatServices$validat2, errors, isValid, plat;
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              _context4.prev = 0;
              id = req.params.id;
              _PlatServices$validat2 = _plat4.default.validateBody(req.body), errors = _PlatServices$validat2.errors, isValid = _PlatServices$validat2.isValid;
            ...
            case 5:
              _context4.next = 7;
              return _plat2.default.findOneAndUpdate({ _id: id }, req.body, { new: true });
            ...
            case 7:
              ...
              return _context4.abrupt("return", res.status(404).json({ err: 'could not find the plat' }));

            case 10:
              return _context4.abrupt("return", res.json(plat));
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              id = req.params.id;
              _context5.next = 4;
              return _plat2.default.findOneAndRemove({ _id: id });
            ...
            case 4:
              ...
              return _context5.abrupt("return", res.status(404).json({ err: 'could not find the plat' }));

            case 7:
              return _context5.abrupt("return", res.json(plat));
...
exports.default = _mongoose2.default.model('plats', platSchema);
...
exports.default = {
    validateBody: function validateBody(body) {
        ...
        body.title = !(0, _isEmpty2.default)(body.title) ? body.title : "";
        body.body = !(0, _isEmpty2.default)(body.body) ? body.body : "";
        body.price = !(0, _isEmpty2.default)(body.price) ? body.price : "";
        body.typePlat = !(0, _isEmpty2.default)(body.typePlat) ? body.typePlat : "";

        if (!_validator2.default.isLength(body.title, { min: 2, max: 30 })) {
            errors.title = "Votre title doit contenir entre 2 et 30 caracteres.";
        }
        if (_validator2.default.isEmpty(body.title)) {
            errors.title = "Un titre est requis.";
        }
        if (_validator2.default.isEmpty(body.typePlat)) {
            errors.typePlat = "Le type du plat est requis.";
        }
        if (_validator2.default.isEmpty(body.body)) {
            errors.body = "Une description du plat est requis.";
        }
        if (_validator2.default.isEmpty(body.price)) {
...
profilRouter.get('/', _passport2.default.authenticate("jwt", { session: false }), _profil2.default.findAll);
...
var _profil = __webpack_require__(34);
...
var _profil3 = __webpack_require__(35);
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 3:
              ...
              return _context2.abrupt("return", res.status(404).json({ err: 'could not find this a user' }));

            case 6:
              return _context2.abrupt("return", res.json(profil));
...
exports.default = _mongoose2.default.model('profils', profilSchema);
...
exports.default = {
    validateProfileInput: function validateProfileInput(data) {
        ...
        data.prenom = !(0, _isEmpty2.default)(data.prenom) ? data.prenom : '';
        data.nom = !(0, _isEmpty2.default)(data.nom) ? data.nom : '';
        data.phone = !(0, _isEmpty2.default)(data.phone) ? data.phone : '';
        data.region = !(0, _isEmpty2.default)(data.region) ? data.region : '';
        data.ville = !(0, _isEmpty2.default)(data.ville) ? data.ville : '';
        data.codePostal = !(0, _isEmpty2.default)(data.codePostal) ? data.codePostal : '';
        data.rue = !(0, _isEmpty2.default)(data.rue) ? data.rue : '';

        if (_validator2.default.isEmpty(data.prenom)) {
            errors.prenom = 'Profil prénom is required';
        }
        if (_validator2.default.isEmpty(data.nom)) {
            errors.nom = 'Profile nom is required';
        }
        if (_validator2.default.isEmpty(data.phone)) {
            errors.phone = 'Profile phone is required';
        }
        if (_validator2.default.isEmpty(data.region)) {
            errors.region = 'Profile region is required';
        }
        if (_validator2.default.isEmpty(data.ville)) {
            errors.ville = 'Profile ville is required';
        }
        if (_validator2.default.isEmpty(data.codePostal)) {
            errors.codePostal = 'Profile codePostal is required';
        }
        if (_validator2.default.isEmpty(data.rue)) {
...
var _passportJwt = __webpack_require__(37);
